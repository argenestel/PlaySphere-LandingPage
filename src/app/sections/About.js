    ...
    <>
      <div className='p-3' id='about'>
        ...
        <div className='mt-10'>
          ...
          <div className='w-full flex justify-center pt-[50px] rounded-b-[50px] md:rounded-b-[100px] overflow-hidden' style={{backgroundImage:`url('/city.jpg')`}}>
            {/* <Image src={'/city.jpg'} width={500} height={500} className='w-full h-full ' /> */}
            <div className='opacity-100 font-dmmono bg-[#0f0f0f80] z-10 backdrop-blur-xl w-full md:w-1/2 rounded-t-[20px] md:p-5 p-2'>
            {/* <div className='opacity-100 font-dmmono bg-[#0f0f0f80] z-10 backdrop-blur-xl left-[50%] bottom-0 w-full md:w-fit -translate-x-1/2 rounded-t-[20px] md:p-5 p-2'> */}
